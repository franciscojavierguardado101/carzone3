...
//after typing the last 3 lines of code we need to go to terminal and write: python manage.py collectstatic

// after that command then we have to choose 'yes' and that's it
//previous 3 lines are for register message to fade out when one makes a mistake
